...
public:
	...
	void MeshPainter::drawMeshshadow(TriMesh* mesh, openGLObject& object, Light* light, Camera* camera);
	...
	// 添加物体
    void addMesh( TriMesh* mesh,  const std::string &texture_image, const std::string &vshader, const std::string &fshader );
